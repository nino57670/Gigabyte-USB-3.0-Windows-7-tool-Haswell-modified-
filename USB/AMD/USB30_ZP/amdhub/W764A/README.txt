...
### Known Issues:
* [Summit AM4] System SW hangs at PC: 02Cb during S3 resume in Legacy Win7 64bit OS

Revision History
-----------------
2.0.0.0026 
	• Delayed enumeration or device become unknown device after S3 resume
	• USB port cannot recognize device after plug/unplug in the same CPU XHCI port in S3 state using Win7
	• device re enumeration happens if device connected behind USB hub

2.0.0.0020 
	• BSOD 1A found while running S4 sleeper with USB devices connected to AMD USB3.0 Ports
	• W7 x64 - BSOD 0xD1/0x3B/0x7E  pointing to amdxhci.sys
